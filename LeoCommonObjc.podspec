...
Pod::Spec.new do |s|
  ...
  s.name         = "LeoCommonObjc"
  s.version      = "1.0"
  s.summary      = "LeoCommonObjc."
  ...
  s.description  = <<-DESC
                    this is LeoCommonObjc
                   DESC

  s.homepage     = "https://github.com/lilizing/LeoCommonObjc"
  ...
  s.source       = { :git => "https://github.com/lilizing/LeoCommonObjc.git", :tag => s.version.to_s }
  ...
  s.source_files  = "LeoCommonObjc/LeoCommonObjc/**/*.{h,m,swift}"
